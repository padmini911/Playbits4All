...
public class AlphabetsActivity extends AppCompatActivity {
    ...
    private void handleCorrectLetter(char scannedLetter) {
        ...
        if (scannedLetter == displayedLetter) {
            ...
            mediaPlayer.start();
            imgView.setImageResource(R.drawable.crt);

        } else {
            mediaPlayer = MediaPlayer.create(this,R.raw.wrong);
            mediaPlayer.start();
            imgView.setImageResource(R.drawable.wrg);
    ...
    private void handleActions(String scannedAlphabet) {
        ...
        switch (scannedAlphabet.toLowerCase()) {
            ...
            case "x":
                ...
                imageResId = R.drawable.xylophone;
                mediaPlayer.start();
                break;
            case "y":
                display = "Y for Yak";
                mediaPlayer = MediaPlayer.create(this, R.raw.yak);
                imageResId = R.drawable.yak;
                mediaPlayer.start();
                break;
            case "z":
                display = "Z for Zebra";
