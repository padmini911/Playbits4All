        ...
        switch (state) {
            ...
            case 1:
                if ("yes".equalsIgnoreCase(text)) {
                    ...
                    imageResId = R.drawable.bigdog;
                    state++;
                } else {
                    display = "Incorrect";
                    audioResId = R.raw.wrong;
                    imageResId = R.drawable.wrg;
                }
                break;
            case 2:
                if ("yes".equalsIgnoreCase(text)) {
            ...
            case 7:
                if ("yes".equalsIgnoreCase(text)) {
                    ...
                    imageResId = R.drawable.horsepics;
                    state++;
                } else {
                    display = "Incorrect";
                    audioResId = R.raw.wrong;
            ...
            case 9:
                if ("no".equalsIgnoreCase(text)) {
                    ...
                    imageResId = R.drawable.elephantpic;
                    state++;
                } else {
                    display = "Incorrect";
                    audioResId = R.raw.wrong;
            ...
            case 20:
                if ("yes".equalsIgnoreCase(text)) {
                    ...
                    imageResId = R.drawable.bigsheep;
                    state++;
                } else {
                    display = "Incorrect";
                    audioResId = R.raw.wrong;
